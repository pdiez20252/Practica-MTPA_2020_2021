...
public class Salon extends javax.swing.JFrame {
    ...
    public Salon(ComunicacionUsuario comunicador) {
        super();
        initComponents();
    ...
    private void initComponents() {
        ...
        txtUnirse = new javax.swing.JTextField();
        ...
        jTablaPersona.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Partida", "Contrincantes + Puntuación"
            }
        ) {
        ...
        jLabel3.setText("Lista de partidas, introduza en UNIRSE el nombre de la partida a la que se quiere unir o cree una partida (debe comenzar con #)");
        ...
        jLabel5.setText("¿Hay partidas pero no se muestran?:");

        txtUnirse.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtUnirseActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtUnirse, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(7, 7, 7)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel4)
                    .addComponent(jLabel5)
                    .addComponent(txtUnirse, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton2))
                .addContainerGap())
        );
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if (partnomb.charAt(0) != '#') {
            JOptionPane.showMessageDialog(null, "Las partidas deben tener hastag (comenzar con #)",  "Error",JOptionPane.ERROR_MESSAGE);
        }
        else{
        ...
        comunicador.mandarMensaje(mensaje);
    ...
    private void jTablaPersonaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablaPersonaMouseClicked
        /*  CÓDIGO PARA UNIRSE A PARTIDA DIRECTAMENTE DANDO CLICK EN LA TABLA   
        JTable source = (JTable)evt.getSource();
            int row = source.rowAtPoint( evt.getPoint() );
            int column = source.columnAtPoint( evt.getPoint() );
            String s=source.getModel().getValueAt(row, column)+"";
            System.out.println("Seleccionado: "+row);
            //protocolo instrucción:sala en la que estamos: columna que hemos pulsado
            String mensaje = "abrirPartida:"+salaactual()+":"+row+"\n";
            ...
            //recorrer marcha atrás el array del servidor, siempre que coincida la sala*/
    ...
    private void txtUnirseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtUnirseActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtUnirseActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String partunirse =  txtUnirse.getText();  
        if(partunirse.isEmpty()){
            JOptionPane.showMessageDialog(null, "No te puedes unir a una partida vacía",  "Error",JOptionPane.ERROR_MESSAGE);
        }
        else{
           //protocolo instrucción:sala en la que estamos: columna que hemos pulsado
            String mensaje = "unirse:"+partunirse+":"+salaactual()+":"+comunicador.getNombre();
              comunicador.mandarMensaje(mensaje);
             
             String respuesta = comunicador.recibirMensaje();
             //System.out.println(respuesta);
             if (respuesta.equals("false")){
                 JOptionPane.showMessageDialog(null, "Imposible unirse, no existe ninguna partida",  "Error",JOptionPane.ERROR_MESSAGE);
             }
             else{
                 
                 new Partida(partunirse, ""+salaactual(),0, comunicador).setVisible(true);
    ...
    public void mostrar(){ 
        ...
        String mensaje = "mostrar:"+salaactual;
         comunicador.mandarMensaje(mensaje);
      
        String respuesta = comunicador.recibirMensaje();
        //System.out.println(""+respuesta);
        String[] dividir = respuesta.split("-");
        int tamanolista = dividir.length;
        int j=0;
        String matriz[][] = new String [tamanolista][2];
        for(int i=0; i<tamanolista;i++){
             
             String [] elementos = dividir[i].split(":");

             matriz[i][0] = elementos[0];
             if(elementos.length>1) matriz[i][1] = elementos[1];
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Salon(null).setVisible(true);
    ...
    private javax.swing.JTextField txtUnirse;
